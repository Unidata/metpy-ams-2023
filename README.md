...
> 1. *Within* the folder where you have this code saved, look for the `environment.yml` file. When within this directory, you can set up your Python environment with `conda env create -f environment.yml` from your command line.  
